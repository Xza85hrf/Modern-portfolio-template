...
import { useTimeline, type TimelineEvent } from "@/lib/config-context";
...
export function JourneyTimeline({ events: propEvents }: JourneyTimelineProps) {
  const prefersReducedMotion = useReducedMotion();
  const configTimeline = useTimeline();

  // Use props if provided, otherwise use config
  const events = propEvents ?? configTimeline;
